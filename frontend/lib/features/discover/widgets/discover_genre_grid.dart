...
class DiscoverGenreGrid extends StatelessWidget {
  final void Function(String label, int tmdbId) onGenreTap;

  const DiscoverGenreGrid({super.key, required this.onGenreTap});
        ...
        children: [
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _GenreCard(
                data: g,
                onTap: () => onGenreTap(g.label, g.tmdbId),
              );
            },
          ),
        ],
...
class _GenreCard extends StatefulWidget {
  ...
  const _GenreCard({required this.data, required this.onTap});
